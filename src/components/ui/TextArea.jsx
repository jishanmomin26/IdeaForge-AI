 ...
 * - Professional blue focus ring with subtle elevation
...
export function TextArea({
  ...
  const baseStyles =
    'w-full px-3.5 py-2.5 bg-white text-slate-900 border rounded-xl text-sm shadow-xs transition-all duration-200 ease-out placeholder:text-slate-400 focus:outline-none disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed resize-y';
