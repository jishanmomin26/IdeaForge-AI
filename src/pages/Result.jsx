      ...
      <div className="py-6 sm:py-12">
        <Container size="lg">
          ...
          <div className="space-y-8">
            ...
            {/* Raw Concept Blueprint (Rendered when live Gemini response is present) */}
            {startup.rawText && (
              <Card className="border-slate-200 shadow-sm bg-white">
                <CardHeader className="bg-slate-50/70 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div>
                    <CardTitle as="h2" className="text-base font-semibold text-slate-900">
                      Gemini AI Generated Blueprint
                    </CardTitle>
                    <CardDescription>
                      Structured response generated by Gemini API
                    </CardDescription>
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="whitespace-pre-wrap text-sm text-slate-800 leading-relaxed font-sans bg-slate-50 p-5 rounded-xl border border-slate-200/80">
                    {startup.rawText}
                  </div>
                </CardContent>
              </Card>
